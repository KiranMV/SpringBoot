...
//	        product.setProdImage(prodImage);
	    ...
	    public List<Products> updateProduct(@PathVariable String id, @RequestBody Products product) {
	    		List<Products> productdata = productRepository.findAll();
	    		System.out.println("productdata..."+productdata);
	    		 for(int i=0; i<productdata.size(); i++) {
	    			 	Products pro = productdata.get(i);
